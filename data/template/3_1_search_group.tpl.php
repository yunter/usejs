...
0
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/header.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/pubsearch.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/thread_list.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/group_list.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/footer.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/common/header_common.htm', 1329445679, '1', './data/template/3_1_search_group.tpl.php', './template/default', 'search/group')
;?>
...
<input type="hidden" name="srchfid" value="<?php echo $srchfid;?>" /><?php $keywordenc = $keyword ? rawurlencode($keyword) : '';?><?php if($searchid || ($_G['gp_adv'] && CURMODULE == 'forum')) { ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['group_bottom'])) echo $_G['setting']['pluginhooks']['group_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { ?><?php $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">
