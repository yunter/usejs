...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1329374647, '1', './data/template/3_1_common_header_home_space.tpl.php', './template/default', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1329374647, '1', './data/template/3_1_common_header_home_space.tpl.php', './template/default', 'common/header_home_space')
;?>
