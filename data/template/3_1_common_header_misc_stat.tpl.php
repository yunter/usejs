...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1329376250, '1', './data/template/3_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1329376250, '1', './data/template/3_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
;?>
