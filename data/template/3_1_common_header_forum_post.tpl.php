...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1329445647, '1', './data/template/3_1_common_header_forum_post.tpl.php', './template/default', 'common/header_forum_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1329445647, '1', './data/template/3_1_common_header_forum_post.tpl.php', './template/default', 'common/header_forum_post')
;?>
